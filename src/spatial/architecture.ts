...
export const architecture={northHeight:128,southHeight:120,sideThickness:8,capHeight:6,southFoot:576};
...
export function wallOverlapsActor(p:Point,scene:string){
 const foot={x:p.x+7,y:p.y+10},top=architecture.southFoot-architecture.southHeight;
