...
export function characterConversation(history:ConversationHistory,characterId:string,limit=8){return history.turns.filter(turn=>turn.characterId===characterId).slice(-Math.max(1,limit))}
