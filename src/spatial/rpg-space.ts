...
export function createRpgSpace(options:SpaceOptions){
 ...
 const revealForeground=createForegroundReveal({textureForScene:id=>`/${id}-front.png`,size:{w:640,h:640},center:{x:7,y:-20},radius:50,opacity:.2,active:wallOverlapsActor});
