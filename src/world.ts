...
export const rooms:Record<SceneId,Room>={
 ...
 ],entities:[file('memo',['投委会摘要','Committee brief'],165,270),{id:'partner',kind:'person',person:'partner',label:['交谈','Talk'],at:{x:545,y:190},approach:{x:515,y:190}},npc('analyst',278,332),{id:'committee',kind:'committee',label:['投委会席位','Committee seat'],at:{x:464,y:488},approach:{x:457,y:532}},door('fund-office','office',['去 RelayOps','To RelayOps'],606,345)]},
...
const southWall=(room:Room):Rect[]=>room.id==='office'
 ?[{x:34,y:548,w:266,h:28},{x:380,y:548,w:226,h:28}]
 :[{x:34,y:548,w:572,h:28}];
